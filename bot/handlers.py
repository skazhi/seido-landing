...
def get_main_keyboard() -> ReplyKeyboardMarkup:
    """
    Основная клавиатура — сгруппирована по функциям для Seido.

    Группы:
    - Мои данные: результаты, поиск по ФИО, профиль
    - Забеги: календарь, поиск, история
    - Сообщество: сравнение, добавление забега, статистика
    - Помощь
    """
    keyboard = [
        # Ряд 1: Мои данные (главное для бегуна)
        [
            KeyboardButton(text="📊 Мои результаты"),
            KeyboardButton(text="🔎 Найти результат"),
            KeyboardButton(text="👤 Мой профиль"),
        ],
        # Ряд 2: Забеги (календарь, поиск, архив)
        [
            KeyboardButton(text="📅 Календарь"),
            KeyboardButton(text="🔍 Поиск"),
            KeyboardButton(text="📜 История"),
        ],
        # Ряд 3: Сообщество и краудсорсинг
        [
            KeyboardButton(text="🏃 Сравнение"),
            KeyboardButton(text="➕ Добавить забег"),
...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    if user:
        ...
        await message.answer(
            ...
            "📌 Вы можете отозвать согласие (напиши @Skazhi)\n"
...
async def cmd_help(message: types.Message):
    ...
    await message.answer(
        ...
        "🔒 Конфиденциальность:\n"
        "Ваши данные защищены. Удаление: /delete или обращение @Skazhi.\n\n"
        "Полная политика: https://skazhi.github.io/seido-landing/docs/offer.md\n\n"
        "💡 Вопросы, претензии, удаление: @Skazhi или Seido_community@mail.ru"
    )
